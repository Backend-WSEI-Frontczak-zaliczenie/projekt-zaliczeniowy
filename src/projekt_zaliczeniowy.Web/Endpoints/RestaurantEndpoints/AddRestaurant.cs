...
public class AddRestaurant: Endpoint<AddRestaurantRequest, RestaurantRecord> {
  private readonly IRestaurantRepository _repository;

  public AddRestaurant(IRestaurantRepository repository)
  {
    _repository = repository;
  }
  public override void Configure()
  {
    Post(AddRestaurantRequest.Route);
    AllowAnonymous();
  }

  public override async Task HandleAsync(AddRestaurantRequest req, CancellationToken ct)
  {
    if (req.City == null || req.Type == null)
    {
      await SendErrorsAsync(400, ct);
      return;
    }
    var restaurant = _repository.Add(req.Name, req.City, req.Type, req.Rating, req.AdultOnly);
    if (restaurant == null)
    {
